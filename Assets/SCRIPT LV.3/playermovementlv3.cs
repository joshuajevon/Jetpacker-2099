...
public class playermovementlv3 : MonoBehaviour
{
    ...
    public GameObject loser, tutor,skoree;
    public GameObject tryagain, level, highscoreee;
    ...
    private void OnTriggerEnter2D(Collider2D collision)
    {
        ...
        {
            skoree.GetComponent<skoree>().score++;
        ...
        if (collision.gameObject.tag == "building")
        {
            ...
            ad.SetActive(true);
            if (PlayerPrefs.GetInt("highscoreee") < skoree.GetComponent<skoree>().score)
            {
                PlayerPrefs.SetInt("highscoreee", skoree.GetComponent<skoree>().score);
            }
